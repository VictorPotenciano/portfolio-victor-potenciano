            ...
            {t.about.experience.jobs.map((job, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`
                      absolute left-[19px] sm:left-[27px] md:left-1/2 top-5 sm:top-6 w-3 h-3 sm:w-4 sm:h-4 rounded-full border-2 sm:border-4 border-white shadow-md transform -translate-x-1/2 z-10 transition-all duration-300
                  ...
                  >
                    {/* Header */}
                    <div className="p-6 md:p-6 relative">
                      {/* Icono de expansión */}
                      <motion.div
                        animate={{ rotate: isExpanded ? 180 : 0 }}
                        transition={{ duration: 0.3 }}
                        className={`absolute top-6 right-6 flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center
                          ${
                            index % 3 === 0
                              ? "bg-purple-100"
                              : index % 3 === 1
